document.addEventListener('DOMContentLoaded', () => {
  ...
  if (changeTextButton) {
    changeTextButton.addEventListener("click", function() {
      // left for when main heading and bio are added later
  ...
  const githubApiUrl = `https://api.github.com/users/${githubUsername}/repos`; // Renamed to avoid conflict
  fetch(githubApiUrl)
    .then(response => {
      if (!response.ok) {
...
// --- "Leave a Message" Section Logic ---
const loadingEl = document.getElementById('loading');
const userListEl = document.getElementById('userList');
const addFormEl = document.getElementById('addUserForm');
const MESSAGE_API_URL = 'https://jsonplaceholder.typicode.com/users'; // Renamed to avoid conflict
